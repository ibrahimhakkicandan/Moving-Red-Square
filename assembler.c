...
//Name Surname - Atila İlhan Yatağan - İbrahim Hakkı Candan - Aykut Başyiğit 
//Numbers - 150118033 - 150118061 - 150115854 
...
//modified when we discover the address of the label or variable that it uses.
    ...
    if((fp = fopen("C:\\Users\\90534\\OneDrive\\Masa�st�\\hw3mikrop2\\eladres.txt","r"))!=NULL);
...
//========================================   FIRST PASS  ======================================================
            while (token)
            {
                ...
                else if (strcmp(token,"push")==0)
                {
					...
					op1 = strtok(NULL,"\n\t\r ");
					chch = ((op1[0]-48)<<6);
                    program[counter]=0x8000+((chch)&0x01f0);
                    counter++;
                }
